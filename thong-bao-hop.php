                        ...
                        <div class="col-md-8 col-xs-12">
                            <article class="body-right">
                                <div class="title-thongbaohop">
                                    <h2><a href="">Thông báo họp Đại hội cổ đông 2016</a></h2>
                                ...
                                <div class="row pd">
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="item-document">
                                            <p><i class="fa fa-file-word-o"></i>Mời họp Đại hội đồng cổ đông thường niên năm 2016</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="item-document-btn">
                                            <a href="" class="btn-als">Download</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- Item -->
                                ...
                                <div class="row pd">
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="item-document">
                                            <p><i class="fa fa-file-pdf-o"></i>Mời họp Đại hội đồng cổ đông thường niên năm 2016</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="item-document-btn">
